...
The results are pretty conclusive, the network seems to be non-random. It's likely that this is the case in almost all networks, but you might want to conduct this test anyway.
