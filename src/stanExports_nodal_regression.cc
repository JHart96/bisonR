...
#include "stanExports_nodal_regression.h"

RCPP_MODULE(stan_fit4nodal_regression_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nodal_regression")
