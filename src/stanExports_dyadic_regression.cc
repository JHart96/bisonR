...
#include "stanExports_dyadic_regression.h"

RCPP_MODULE(stan_fit4dyadic_regression_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_dyadic_regression")
