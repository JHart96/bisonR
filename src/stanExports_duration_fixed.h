...
namespace model_duration_fixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_duration_fixed");
    reader.add_event(36, 34, "end", "model_duration_fixed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_duration_fixed
  : public stan::model::model_base_crtp<model_duration_fixed> {
private:
        int N;
        int M;
        std::vector<int> dyad_ids;
        int K_fixed;
        std::vector<double> y;
        std::vector<int> k;
        vector_d d;
        matrix_d X;
public:
    model_duration_fixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_duration_fixed_namespace::model_duration_fixed";
        ...
        try {
            ...
            validate_non_negative_index("dyad_ids", "N", N);
            context__.validate_dims("data initialization", "dyad_ids", "int", context__.to_vec(N));
            dyad_ids = std::vector<int>(N, int(0));
            vals_i__ = context__.vals_i("dyad_ids");
            pos__ = 0;
            size_t dyad_ids_k_0_max__ = N;
            for (size_t k_0__ = 0; k_0__ < dyad_ids_k_0_max__; ++k_0__) {
                dyad_ids[k_0__] = vals_i__[pos__++];
            }
            size_t dyad_ids_i_0_max__ = N;
            for (size_t i_0__ = 0; i_0__ < dyad_ids_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "dyad_ids[i_0__]", dyad_ids[i_0__], 0);
            }
            ...
            context__.validate_dims("data initialization", "k", "int", context__.to_vec(M));
            k = std::vector<int>(M, int(0));
            vals_i__ = context__.vals_i("k");
            pos__ = 0;
            size_t k_k_0_max__ = M;
            for (size_t k_0__ = 0; k_0__ < k_k_0_max__; ++k_0__) {
                k[k_0__] = vals_i__[pos__++];
            }
            size_t k_i_0_max__ = M;
            ...
            context__.validate_dims("data initialization", "d", "vector_d", context__.to_vec(M));
            d = Eigen::Matrix<double, Eigen::Dynamic, 1>(M);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("log_pn", "N", N);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> log_pn(N);
            stan::math::initialize(log_pn, DUMMY_VAR__);
            stan::math::fill(log_pn, DUMMY_VAR__);
            stan::math::assign(log_pn,multiply(X, beta_fixed));
            // validate transformed parameters
            const char* function__ = "validate transformed params";
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 18;
            size_t log_pn_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < log_pn_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(log_pn(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: log_pn" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable log_pn: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            // model body
            current_statement_begin__ = 23;
            lp_accum__.add(exponential_log(y, elt_divide(stan::model::rvalue(lambda, stan::model::cons_list(stan::model::index_multi(dyad_ids), stan::model::nil_index_list()), "lambda"), stan::math::exp(log_pn))));
            current_statement_begin__ = 24;
            lp_accum__.add(poisson_log(k, elt_multiply(lambda, d)));
            current_statement_begin__ = 27;
            lp_accum__.add(exponential_log(lambda, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_duration_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> lambda = in__.vector_lb_constrain(0, M);
        size_t lambda_j_1_max__ = M;
        for (size_t j_1__ = 0; j_1__ < lambda_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            current_statement_begin__ = 18;
            validate_non_negative_index("log_pn", "N", N);
            Eigen::Matrix<double, Eigen::Dynamic, 1> log_pn(N);
            stan::math::initialize(log_pn, DUMMY_VAR__);
            stan::math::fill(log_pn, DUMMY_VAR__);
            stan::math::assign(log_pn,multiply(X, beta_fixed));
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < log_pn_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "log_pn" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        if (!include_gqs__) return;
...
typedef model_duration_fixed_namespace::model_duration_fixed stan_model;
#ifndef USING_R
