...
namespace model_binary_fixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(32, 30, "end", "model_binary_fixed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_binary_fixed
  : public stan::model::model_base_crtp<model_binary_fixed> {
private:
        int N;
        int K_fixed;
        std::vector<int> y;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_binary_fixed_namespace::model_binary_fixed";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_binary_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_binary_fixed_namespace::model_binary_fixed stan_model;
#ifndef USING_R
