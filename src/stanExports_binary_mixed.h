...
namespace model_binary_mixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(43, 41, "end", "model_binary_mixed");
    return reader;
}
#include <stan_meta_header.hpp>
class model_binary_mixed
  : public stan::model::model_base_crtp<model_binary_mixed> {
private:
        int N;
        int K_fixed;
        int K_random;
        ...
        std::vector<int> G;
public:
    model_binary_mixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_binary_mixed_namespace::model_binary_mixed";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "divisor", "int", context__.to_vec(N));
            divisor = std::vector<int>(N, int(0));
            vals_i__ = context__.vals_i("divisor");
            pos__ = 0;
            size_t divisor_k_0_max__ = N;
            for (size_t k_0__ = 0; k_0__ < divisor_k_0_max__; ++k_0__) {
                divisor[k_0__] = vals_i__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(binomial_log(y, divisor, inv_logit(lprobs)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_binary_mixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::math::assign(y_pred, binomial_rng(divisor, inv_logit(lprobs), base_rng__));
...
typedef model_binary_mixed_namespace::model_binary_mixed stan_model;
#ifndef USING_R
