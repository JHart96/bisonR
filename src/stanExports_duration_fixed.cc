...
#include "stanExports_duration_fixed.h"

RCPP_MODULE(stan_fit4duration_fixed_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_duration_fixed")
