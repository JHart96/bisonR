...
namespace model_duration_null_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_duration_null");
    reader.add_event(35, 33, "end", "model_duration_null");
    return reader;
}
#include <stan_meta_header.hpp>
class model_duration_null
  : public stan::model::model_base_crtp<model_duration_null> {
private:
        int N;
        int M;
        int K_fixed;
        ...
        matrix_d X;
public:
    model_duration_null(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_duration_null_namespace::model_duration_null";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(exponential_log(y, elt_divide(lambda, stan::math::exp(log_pn))));
            current_statement_begin__ = 23;
            lp_accum__.add(poisson_log(k, multiply(lambda, d)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_duration_null_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_duration_null_namespace::model_duration_null stan_model;
#ifndef USING_R
